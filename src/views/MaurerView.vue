      ...
      <v-col md="5">
        <v-card variant="text" class="mb-5">
          ...
          <v-card-text class="px-0 pb-0">
            <p>
              Das Maurer-Schema ist ein von Klaus Maurer entwickeltes Verfahren zur Risikobewertung
              bei Großveranstaltungen. Mithilfe eines Algorithmus kann ermittelt werden, welches
              Gefahrenpotenzial von einer Veranstaltung ausgeht und wie viele Einsatzkräfte des
              Sanitätswachdienstes vorgehalten werden sollten. Dem Algorithmus liegen
              Erfahrungswerte zugrunde, die gegebenenfalls noch an die örtlichen Gegebenheiten
              angepasst werden müssen.
            </p>
            <small class="d-block my-2">
              Quelle: K. Maurer, H. Peter (Hrsg.) "Gefahrenabwehr bei Großveranstaltungen" Wien,
              2005.
            </small>
          </v-card-text>
        ...
        <v-card class="mt-5">
          ...
          <v-card-text>
            ...
            <div class="text-h6 text-medium-emphasis font-weight-regular">
              = {{ visitors }} Punktwert Besucher &times; {{ rg }} Faktor + {{ risk }} Punktwert
              Risiko
            </div>
          </v-card-text>
        ...
        <v-form ref="form">
          ...
          <v-card class="my-4">
            <v-card-text>
              ...
              <v-checkbox
                v-model="fg.indoor"
                label="Veranstaltung in geschlossenen Räumen"
              ></v-checkbox>
            </v-card-text>
          </v-card>
